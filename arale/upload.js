/*
 * This is a fork of arale/upload. The major differences are:
 * 1. The form overlay is appended to the container rather than the body element
 * 2. The form is positioned with offsetLeft & offsetTop because of 1).
 * 3. This does not support IE[67] well bacause of 2).
 *
 * References:
 * - https://github.com/aralejs/upload
 * - https://github.com/blueimp/jQuery-File-Upload/issues/1795
 * - http://www.quirksmode.org/dom/w3c_cssom.html#t32
...
Uploader.prototype.setup = function() {
  ...
  this.form.attr('action', this.settings.action)
